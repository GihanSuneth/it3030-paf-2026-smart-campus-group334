...
export function BookingCard({ booking, resourceName, actions }) {
  return (
    <article className="interactive-card flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
      <div className="space-y-2">
        ...
        <p className="text-sm leading-6 text-slate-600">{booking.purpose}</p>
